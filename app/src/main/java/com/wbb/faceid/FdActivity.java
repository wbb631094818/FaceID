...
public class FdActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    private static final String TAG = "wbbb";
    ...
    private boolean isFrontCamera = true;  // 是否是前置
...
//    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOpenCvCameraView = (JavaCamera2View) findViewById(R.id.fd_activity_surface_view);
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (isScreenOriatationPortrait(FdActivity.this)) {
            if (isFrontCamera) {
